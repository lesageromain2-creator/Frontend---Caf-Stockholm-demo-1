    ...
    <AdminLayout>
      ...
      <div className="min-h-screen bg-white">
        ...
        <header className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="font-heading text-2xl text-gray-900">Finances & Revenus</h1>
                <p className="text-small text-gray-600 mt-1">Analyse financière et rapports</p>
              </div>
              <div className="flex gap-3">
                <select
                  value={period}
                  onChange={(e) => setPeriod(e.target.value as any)}
                  className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-md text-gray-900 text-xs focus:outline-none focus:ring-2 focus:ring-kafe-primary"
                >
                ...
                <button
                  ...
                  className="text-xs px-3 py-2 bg-kafe-primary text-white rounded-md hover:bg-kafe-primary-dark transition font-medium flex items-center gap-2"
                >
        ...
        <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {statCards.map((card, index) => (
                ...
                >
                  ...
                  <p className="text-small text-gray-600 mb-1">{card.title}</p>
          ...
          {/* Graphique revenus */}
          <section>
            <h2 className="font-heading text-xl text-gray-900 mb-4">Évolution du chiffre d'affaires</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <section>
              <h2 className="font-heading text-xl text-gray-900 mb-4">Ventes par catégorie</h2>
              <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
            ...
            {/* Top produits */}
            <section>
              <h2 className="font-heading text-xl text-gray-900 mb-4">Top 10 produits</h2>
              <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                <ResponsiveContainer width="100%" height={300}>
          ...
          {/* Actions rapides */}
          <section>
            <h2 className="font-heading text-xl text-gray-900 mb-4">Rapports</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="bg-white rounded-lg p-6 border border-gray-200 hover:border-kafe-primary hover:bg-gray-50 transition-all text-left group shadow-sm">
                <FileText className="w-8 h-8 text-kafe-primary mb-3" />
                <h3 className="font-heading text-lg text-gray-900 mb-1 group-hover:text-kafe-primary transition-colors">
                  Rapport TVA
                </h3>
                <p className="text-small text-gray-600">Génerer le rapport de TVA</p>
              </button>
              ...
              <button className="bg-white rounded-lg p-6 border border-gray-200 hover:border-kafe-primary hover:bg-gray-50 transition-all text-left group shadow-sm">
                ...
                <p className="text-small text-gray-600">Marges et bénéfices par produit</p>
              </button>
              ...
              <button className="bg-white rounded-lg p-6 border border-gray-200 hover:border-kafe-primary hover:bg-gray-50 transition-all text-left group shadow-sm">
                ...
                <p className="text-small text-gray-600">Répartition par méthode</p>
              </button>
            </div>
          </section>
        </main>
